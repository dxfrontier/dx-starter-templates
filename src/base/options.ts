...
export class BaseOptions {
  ...
  public static sharedOptions<T extends BaseProjectOptions | JsiiProjectOptions>(
    ...
    return {
      ...
      packageManager: options.npmEnabled && options.packageManager ? options.packageManager : NodePackageManager.NPM,
      npmignoreEnabled: options.npmEnabled && options.npmignoreEnabled ? options.npmignoreEnabled : false,
      projenrcTs: options.typescriptEnabled && options.projenrcTs ? options.projenrcTs : true,
      ...
      prettier: options.prettierEnabled && options.projenEnabled && options.prettier ? options.prettier : false,
      eslint: options.eslintEnabled && options.projenEnabled && options.eslint ? options.eslint : false,
      ...
      pullRequestTemplate: options.githubEnabled && options.projenEnabled && options.pullRequestTemplate ? options.pullRequestTemplate : false,
      depsUpgrade: options.githubEnabled && options.projenEnabled && options.depsUpgrade ? options.depsUpgrade : false,
      sampleCode: options.sampleCodeEnabled && options.projenEnabled && options.sampleCode ? options.sampleCode : false,
    };
  }
}
